...
First, we need to configure the SDK: You can do this with the helper program <a href="https://docs.espressif.com/projects/esp-idf/en/latest/esp32/api-reference/kconfig.html">menuconfig</a>, oIN r alternatively by creating a file called *sdkconfig.defaults* in the root folder of your project and pasting the following content: 
...
In the <a href="http://127.0.0.1:4000/esp32/ble/2021/06/08/esp32-ota-part-2.html">next part</a>  we will look at the OTA process itself and how we can implement it on the ESP32. 
